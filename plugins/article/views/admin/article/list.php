...
<script>
  ...
  Ext.onReady(
    function() 
    {
        ...
        $("#addbtn").click(function(){
            ...
            ST.Util.addTab('添加文章','{$cmsurl}article/admin/article/add/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/1',0);
        });
  ...
  //修改
    function goModify(id)
    {
        ...
        var url = SITEURL+'article/admin/article/edit/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/1/id/'+id;
