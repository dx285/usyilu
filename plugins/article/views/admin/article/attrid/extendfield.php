...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            var url=SITEURL+"article/admin/attrid/extendlist/action/add/typeid/{$typeid}";
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'article/admin/attrid/extendlist/action/read/typeid/{$typeid}',  //读取数据的URL
                    destroy:  SITEURL+'article/admin/attrid/extendlist/action/delete/typeid/{$typeid}'
...
function togStatus(obj, record, field) {
    ...
    Ext.Ajax.request({
        url: SITEURL+"article/admin/attrid/extendlist/action/update",
        method: "POST",
        datatype: "JSON",
