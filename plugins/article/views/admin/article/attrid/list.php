    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'article/admin/attrid/list/action/read/typeid/{$typeid}',  //读取数据的URL
                    update:  SITEURL+'article/admin/attrid/list/action/save/typeid/{$typeid}',
                    destroy:  SITEURL+'article/admin/attrid/list/action/delete/typeid/{$typeid}'
                },
                reader: 'json'
            },
            autoLoad: true,
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    drop: function (node, data, overModel, dropPosition, eOpts) {
                        ...
                        Ext.Ajax.request({
                            url: SITEURL+'article/admin/attrid/list/action/drag/typeid/{$typeid}',
                            params: params,
                            method: 'POST',
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'article/admin/attrid/list/action/addsub/typeid/{$typeid}',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type,callback)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"article/admin/attrid/list/action/update/typeid/{$typeid}",
        method  :  "POST",
        datatype  :  "JSON",
...
function attrSet(id,typeid)
{
    ...
    var boxurl = SITEURL+'article/admin/attrid/config/id/'+id+'/typeid/'+typeid;
