                ...
                {st:line action="query" flag="order" row="2"}
                 ...
                 {loop $data $r}
                    <li {if $k%2==0}class="mr_0"{/if}>
                        ...
                        <div class="pic"><a href="{$r['url']}" target="_blank"><img src="{Common::img($r['litpic'],200,140)}" alt="{$r['title']}" /></a></div>
                        <div class="js">
                            ...
                            <p class="price">
                                {if !empty($r['sellprice'])}
                                    <em>原价：<del><i class="currency_sy">{Currency_Tool::symbol()}</i>{$r['sellprice']}</del></em>
                                {/if}
                                {if !empty($r['price'])}
                                <span><b><i class="currency_sy">{Currency_Tool::symbol()}</i>{$r['price']}</b>元</span>
                                {else}
                                <span>电询</span>
                                {/if}
                            </p>
