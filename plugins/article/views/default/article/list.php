          ...
          <div class="st-gl-list-con">
           {if !empty($list)}
          	<ul>
                {loop $list $a}
            	    <li>
                        <div class="pic"><i>HOT</i><a href="{$a['url']}" target="_blank"><img src="{Product::get_lazy_img()}" st-src="{Common::img($a['litpic'],320,218)}" alt="{$a['title']}" /></a></div>
                        <div class="con">
                          <p class="tit">
                          ...
                          <p class="data">
                            ...
                            <span class="date">{Common::mydate('Y-m-d',$a['modtime'])}</span>
                          </p>
                        </div>
                    </li>
                {/loop}
