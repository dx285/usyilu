...
<body>
    ...
    <section>
        ...
        <div class="mid_content">
            ...
            <div  class="am-slider am-slider-default"  id="raiders-column" >
                <ul class="am-slides">
            ...
            <div class="st_search_box">
                <input type="text" class="st_home_txt keyword" placeholder="搜索攻略" />
                ...
                <ul>
                    ...
                    <li>
                        <a href="{$articlerow['url']}">
                            <div class="pic"><img src={$defaultimg} st-src="{Common::img($articlerow['litpic'],100,68)}" alt="{$articlerow['title']}" /></div>
                            <div class="con">
                                <p class="bt">{$articlerow['title']}</p>
                                <p class="txt">{Common::cutstr_html($articlerow['summary'],30)}</p>
                                <p class="data">
                                    <span class="mdd">{$articlerow['finaldest']['kindname']}</span>
