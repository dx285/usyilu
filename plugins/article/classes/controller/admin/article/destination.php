 ...
 * 线路目的地控制器
 */
class Controller_Admin_Article_Destination extends Stourweb_Controller
{
    ...
    public function action_destination()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/article/destination/destination');
        }
        else if ($action == 'read')
        {
    ...
    */
    ...
    public function action_dialog_productinfo()
    {
        ...
        $this->display('admin/article/destination/dialog_productinfo');
    }
}