...
class Controller_Admin_Article_Attrid extends Stourweb_Controller
{
    private $_typeid = 4;
    ...
    public function action_list()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/article/attrid/list');
        }
        else if ($action == 'read')
        {
    ...
    public function action_config()
    {
        ...
        $this->assign('typeid', $typeid);
        $this->display('admin/article/attrid/config');
    }
    ...
    public function action_extendlist()
    {
        ...
        if (empty($action))
        {
            ...
            $this->assign('typeid', $typeid);
            $this->assign('channelname', $channelname);
            $this->display('admin/article/attrid/extendfield');
        }
        else if ($action == 'read')
        {
        ...
        else if ($action == 'add')
        {
            ...
            $this->display('admin/article/attrid/addfield');
        }
    ...
    public function action_content()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/article/attrid/content');
        }
        else if ($action == 'save')
        {
    ...
    public function action_dialog_delfield()
    {
        ...
        $this->assign('id', $id);
        $this->display('admin/article/attrid/dialog_delfield');
    }
