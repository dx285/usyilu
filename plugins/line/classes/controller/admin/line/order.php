...
class Controller_Admin_Line_Order extends Stourweb_Controller
{
    ...
    public function action_view()
    {
        ...
        $info['totalprice']=Model_Member_Order::order_total_price($info['id'],$info);
        $info['payprice']=Model_Member_Order::order_total_payprice($info['id'],$info);
        //是否使用了优惠券
        if(St_Functions::is_normal_app_install('coupon'))
        {
            $iscoupon = Model_Coupon::order_view($info['ordersn']);
