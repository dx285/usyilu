...
<script>
   ...
   $(".additem").click(function(){
       ...
       $.ajax({
           type: 'POST',
           url: SITEURL+"line/admin/attrid/ajax_addfield/typeid/{$typeid}",
           dataType:'json',
  ...
  function rowSave()
  {
      ...
      Ext.Ajax.request({
          url   :  SITEURL+"line/admin/attrid/content/action/save/typeid/{$typeid}",
          method  :  "POST",
          isUpload :  true,
          form  : "day_fm",
          datatype  :  "JSON",
  ...
  {
      ST.Util.showBox('删除字段',SITEURL+'line/admin/attrid/dialog_delfield?id='+id+"&typeid="+typeid,400,'',null,null,document,{loadWindow:window,loadCallback:backDel,maxHeight:600});
