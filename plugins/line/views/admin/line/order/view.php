               ...
               <!--基础信息开始-->
                  <div class="product-add-div">
                      <div class="add-class">
                          ...
                          <dl class="list_dl">
                              <dt class="wid_90">发票信息：</dt>
                              <dd style="height: auto">
                                  <ul>
                                      <li>发票抬头:{$bill['title']}</li>
                                      <li>收件人:{$bill['receiver']}</li>
                                      <li>联系电话:{$bill['mobile']}</li>
                                      <li>邮寄地址:{$bill['province']} {$bill['city']} {$bill['address']}</li>
                                  </ul>
