              ...
              <div class="add-class">
                  ...
                  <dl>
                      ...
                      <dd>
                              ...
                              <div class="on-off">
                                  <input type="radio" name="paytype" value="1" {if $info['paytype']=='1' OR empty($info['paytype'])}checked="checked"{/if} />全款支付 &nbsp;
                              ...
                              <div class="price_sub">
                                  <div>
                                      <table class="price_tb">
                                          ...
                                          <tr>
                                              <td class="tit">价格描述：</td><td><input type="text" class="set-text-xh text_700 mt-2" style="width: 300px" value="{$info['lastoffer']['description']}" name="description"></td>
                                          </tr>
                                          <tr>
                                              <td class="tit">单房差：</td><td><input type="text" class="set-text-xh text_700 mt-2" style="width: 100px" value="{$info['lastoffer']['roombalance']}" name="roombalance"></td>
                                          </tr>
                                          <tr>
                                              <td class="tit">库存：</td><td><input type="text" class="set-text-xh text_100 mt-2" name="number" maxlength="4" value="{$info['lastoffer']['number']}"> <span style="color:gray;padding-left:10px">-1表示不限</span></td>
                                          </tr>
                                      </table>
