            ...
            <div class="manage-nr">
                ...
                <div class="w-set-tit bom-arrow">
                    <span class="on" id="column_basic" onclick="Product.switchTab(this,'basic')"><s></s>基础信息</span>
                        ...
                        {loop $columns $col}
                          <span id="column_{$col['columnname']}" onclick="Product.switchTab(this,'{$col['columnname']}',switchBack)"><s></s>{$col['chinesename']}</span>
                        {/loop}
                        ...
                        <dl>
                            ...
                            <dd>
                                    <select name="webid">
                                        ...
                                        {loop $weblist $web}<?php var_dump($web['webid'],$info['webid']);?>
                ...
                <div id="content_jieshao" class="product-add-div content-hide">
                    ...
                    <div class="ap-div-top">
                        <dl>
                            ...
                            <dd>
                                <div class="temp-chg">
                                    <a {if $info['isstyle']==2 OR empty($info['isstyle'])}class="on"{/if} href="javascript:void(0)" onclick="togStyle(this,2)">标准版</a>
                                    <a {if $info['isstyle']==1}class="on"{/if} href="javascript:void(0)" onclick="togStyle(this,1)">简洁版</a>
                        ...
                        <dl>
                            ...
                            <dd>
                            <div class="on-off">
                              <input type="radio" id="" class="fl mt-8" onclick="togDiner(1)" name="showrepast" value="1" {if $info['showrepast']==1 OR !isset($info['showrepast'])}checked="checked"{/if}>
                              <label class="fl mr-20 ml-5">显示</label>
                              <input type="radio" id="" class="fl mt-8" onclick="togDiner(0)" {if $info['showrepast']==0 AND isset($info['showrepast'])}checked="checked"{/if} name="showrepast" value="0">
...
<script>
 ...
 var is_spot_open={if St_Functions::is_system_app_install(5)}1{else}0{/if};
