...
class Controller_Admin_Hotel_Calendar extends Stourweb_Controller
{
    private $_typeid=2;
    private $_price_table = 'hotel_room_price';
    public function action_index()
    {
        ...
        $this->display('admin/hotel/calendar/index');
    }
    ...
    public function get_suitprice_arr($year, $month, $suitid)
    {
        ...
        foreach ($arr as $row)
        {
            if ($row)
            {
                ...
                $price[$day]['basicprice'] =  $row['basicprice'];
                $price[$day]['profit'] =  $row['profit'];
                $price[$day]['price'] = $row['price'];
