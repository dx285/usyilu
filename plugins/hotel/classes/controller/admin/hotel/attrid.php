...
/**
 * Class Controller_Admin_Hotel_Attrid
 * 酒店属性管理
 */
class Controller_Admin_Hotel_Attrid extends Stourweb_Controller
{
    private $_typeid = 2;
    ...
    public function action_list()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/hotel/attrid/list');
        }
        else if ($action == 'read')
        {
    ...
    public function action_config()
    {
        ...
        $this->assign('typeid', $typeid);
        $this->display('admin/hotel/attrid/config');
    }
    ...
    public function action_extendlist()
    {
        ...
        if (empty($action))
        {
            ...
            $this->assign('typeid', $typeid);
            $this->assign('channelname', $channelname);
            $this->display('admin/hotel/attrid/extendfield');
        }
        else if ($action == 'read')
        {
        ...
        {
            $this->display('admin/hotel/attrid/addfield');
        }
    ...
    public function action_content()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/hotel/attrid/content');
        }
        else if ($action == 'save')
        {
    ...
    public function action_dialog_delfield()
    {
        ...
        $this->assign('id', $id);
        $this->display('admin/hotel/attrid/dialog_delfield');
    }
