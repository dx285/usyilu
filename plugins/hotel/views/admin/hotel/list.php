...
<script>
  ...
  Ext.onReady(
    function() 
    {
        ...
        $("#addbtn").click(function(){
            ST.Util.addTab('添加酒店',SITEURL+'hotel/admin/hotel/add/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/product/itemid/2',0);
        });
			   ...
			   },
			    {
				   ...
				   renderer : function(value, metadata,record) {
					   ...
					   return "<a href='javascript:void(0);' title='编辑'  class='row-mod-btn' onclick=\"goModify("+id+")\"></a>"
                              +"&nbsp;&nbsp;<a href='javascript:void(0);' title='克隆' class='row-clone-btn' onclick=\"ST.Util.goClone("+id+",'hotel/admin/hotel')\"></a>";
                    },
					 listeners:{
					     afterrender:function(obj,eopts)
						{
						 ...
						 if(id.indexOf('suit')!=-1)
						   {
                             ...
                             return '<a href="javascript:;"  class="row-add-suit-btn" onclick="ST.Util.addTab(\'添加房型\',\'hotel/admin/hotel/room_op/menuid/{$_GET['menuid']}/parentkey/product/itemid/2/action/add/hotelid/'+id+'\')">添加房型</a>';
  ...
  function goModify(id)
  {
      ...
      var url = SITEURL+'hotel/admin/hotel/edit/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/product/itemid/2/id/'+id;
  ...
  {
      var url = SITEURL+'hotel/admin/hotel/room/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/product/itemid/2/hotelid/'+id;
...
//modSuit
  function modSuit(roomid,hotelid)
  {
      ...
      var title = record.get('title');
      var url = SITEURL+'hotel/admin/hotel/room_op/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/product/itemid/2/action/edit/hotelid/'+hotelid+'/roomid/'+roomid;
