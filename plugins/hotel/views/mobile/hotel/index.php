     ...
     <div class="st_search">
      <div class="search-and-map">
	    <div class="st_search_box">
          ...
          <a class="map-near" href="http://{$GLOBALS['main_host']}/plugins/productmap/hotel/mapnear"></a>
      </div>
     </div>
      {else}
        <div class="st_search">
      ...
      {st:dest action="query" flag="channel_nav" typeid="2" row="3"}
        ...
        <div class="st_list_con">
                ...
                {loop $list $h}
                    <li>
                           <a href="{$h['url']}">
                            ...
                            <p class="num">
                                {if !empty($h['price'])}
                                  <span><i class="currency_sy">{Currency_Tool::symbol()}</i><strong>{$h['price']}</strong>起</span>
                                {else}
          ...
          <div class="list_more"><a href="{$cmsurl}hotels/{$row['pinyin']}">查看更多</a></div>
