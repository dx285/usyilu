        ...
        <div class="book_type">
            ...
            <div class="book_con_box">
                <ul>
                    ...
                    {loop $data $r}
                    <li data-suitid="{$r['id']}" date-start="{date('Y-m-d',$r['startTime'])}" data-minprice="{$r['price']}" date-end="{date('Y-m-d',$r['endTime'])}" data-jftp="{$r['jifentprice']}">{$r['title']}</li>
                    {/loop}
                    {/st}
                </ul>
            </div>
                    ...
                    <p>
                        ...
                        <span>
                            <input type="text" style="  width: 200px;border: 0;text-align: left" class="leavedate"
                                   name="leavedate" id="leavedate" value=""/>
                        </span>
                        <span>&gt;</span>
                    </p>
...
<script>
    $(function () {
        ...
        $(".book_con_box").find('li').click(function () {
            ...
            $("#suitid").val(suitid);
            $('#startdate').val($(this).attr('date-start'));
            $('#leavedate').val($(this).attr('date-end'));
    ...
    function get_range_price() {
        ...
        $.getJSON(url, {startdate: startdate, leavedate: leavedate, suitid: suitid, dingnum: dingnum}, function (data) {
            ...
            $('.totalprice').attr('data-price' ,data.price+money);
        })
    }
