 ...
 * 线路目的地控制器
 */
class Controller_Admin_Car_Destination extends Stourweb_Controller
{
    ...
    public function action_destination()
    {
        ...
        if (empty($action))
        {
            ...
            $this->display('admin/car/destination/destination');
        }
        else if ($action == 'read')
        {
    ...
    */
    ...
    public function action_dialog_productinfo()
    {
        ...
        $this->display('admin/car/destination/dialog_productinfo');
    }
}