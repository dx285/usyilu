    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="w-set-tit bom-arrow">
                {template 'admin/car/attrid/kind_top'}
    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'car/admin/attrid/list/action/read/typeid/{$typeid}',  //读取数据的URL
                    update:  SITEURL+'car/admin/attrid/list/action/save/typeid/{$typeid}',
                    destroy:  SITEURL+'car/admin/attrid/list/action/delete/typeid/{$typeid}'
                },
                reader: 'json'
            },
            autoLoad: true,
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    drop: function (node, data, overModel, dropPosition, eOpts) {
                        ...
                        Ext.Ajax.request({
                            url: SITEURL+'car/admin/attrid/list/action/drag/typeid/{$typeid}',
                            params: params,
                            method: 'POST',
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'car/admin/attrid/list/action/addsub/typeid/{$typeid}',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type,callback)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"car/admin/attrid/list/action/update/typeid/{$typeid}",
        method  :  "POST",
        datatype  :  "JSON",
...
function attrSet(id,typeid)
{
    ...
    var boxurl = SITEURL+'car/admin/attrid/config/id/'+id+'/typeid/'+typeid;
