...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            var url=SITEURL+"car/admin/attrid/extendlist/action/add/typeid/{$typeid}";
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'car/admin/attrid/extendlist/action/read/typeid/{$typeid}',  //读取数据的URL
                    destroy:  SITEURL+'car/admin/attrid/extendlist/action/delete/typeid/{$typeid}'
