        ...
        <div class="confirm_order_msg">
            <dl>
                ...
                <dd>
                    ...
                    <strong><i class="currency_sy">{Currency_Tool::symbol()}</i><b id="minprice">{$info['price']}</b>起</strong>
                </dd>
            </dl>
        </div>
        <!--产品简介-->
        ...
        <div class="book_type">
            ...
            <div class="book_con_box">
                <ul>
                    ...
                    {loop $data $r}
                    <li data-suitid="{$r['id']}" data-jftp="{$r['jifentprice']}" date-start="{date('Y-m-d',$r['startTime'])}" data-price="{$r['price']}">{$r['title']}</li>
                    {/loop}
                    {/st}
                </ul>
            </div>
            ...
            <div class="book_type">
                ...
                <div class="people_num">
                    <p class="startdate">
                        <strong>开始日期：</strong>
                        <span>
                            <input type="text" style="  width: 200px;border: 0;text-align: left"  name="startdate" id="startdate" value=""/>
                        </span>
                        <span>&gt;</span>
                    </p>
                    ...
                    <p  class="leavedate">
                        <strong>结束日期：</strong>
                        <span>
                            <input type="text" style="  width: 200px;border: 0;text-align: left" name="leavedate" id="leavedate" value=""/>
                        </span>
                        <span>&gt;</span>
                    </p>
                    ...
                    <p>
                        <strong>租车费用：</strong>
                        <span>
                            <em><i class="currency_sy">{Currency_Tool::symbol()}</i><b id="unit-price"></b></em>
                        </span>
                    </p>
            ...
            <div class="book_type">
                ...
                <div class="linkman">
                    <dl>
                        ...
                        <dd>
                            <strong>姓名：</strong>
                            <input type="text" id="linkman" name="linkman" placeholder="预订联系人姓名" class="" value="{$member['truename']}"/>
                            <span>(必填)</span>
                        </dd>
                        <dd>
                            <strong>联系电话：</strong>
                            <input type="text" id="linktel" name="linktel" class="" placeholder="手机号或固定电话" value="{$member['mobile']}"/>
                            <span>(必填)</span>
                        </dd>
                       <!-- <dd>
                            <strong>身份证号：</strong>
                            <input type="text" id="linkidcard" name="linkidcard" class="" placeholder="输入18位身份证号码" value="{$member['cardid']}"/></dd>
                        -->
                        <dd>
                            <strong>订单备注：</strong>
...
<script>
    ...
    function get_range_price() {
        ...
        $.getJSON(url, {startdate: startdate, leavedate: leavedate, suitid: suitid, dingnum: dingnum}, function (data) {
            ...
            $('.totalprice').attr('data-price',data.price);
