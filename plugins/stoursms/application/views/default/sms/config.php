        ...
        <form id="configfrm">
            <table>
                <tr>
                    ...
                    <td>
                        <table style="border: 0;">
                            <tr>
                                <td><input type="radio" name="isopen" {if $provider['isopen']=='0'} checked {/if}  value="0" />
                                </td>
                                <td>关</td>
                                <td style="width: 20px"></td>
                                <td><input type="radio" name="isopen" {if $provider['isopen']=='1'} checked {/if}  value="1" />
                                </td>
                                <td>开</td>
                            </tr>
                        </table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="cfg_sms_username" id="cfg_sms_username" value="{$cfg_sms_username}" />
                    </td>
                    <td class="tb-hint">
                        购买思途短信时所使用的官网账号、密码
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="cfg_sms_password" id="cfg_sms_password" value="{$cfg_sms_password}" />
                    </td>
                    <td class="tb-hint">
                    </td>
                </tr>
...
<div class="sms-num">剩余短信：<strong>{$balance}</strong>条</div>
<div class="sms-set">
    <div class="msg-bar">
