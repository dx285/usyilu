        ...
        <div class="product-manage">
            ...
            <div class="pro-mge-con">
                <ul class="clearfix">
                    ...
                    <?php  if(in_array($data['typeid'],array(4,6,10,11,14,101,null))){$_article[]=$data;continue;}?>
                    <li>
...
<!--                            <strong class="column-tit"><a href="javascript:;" class="product_item" data-url="<?php echo $data['url'];?>"><?php if(!empty($data['typeid'])) { ?><?php echo Model_Menu_New::get_nav_title($data['typeid'],'shortname');?><?php } else { ?><?php echo $data['title'];?><?php } ?>
                            ...
                            <strong class="column-tit"><a href="javascript:;" class="product_item" data-url="<?php echo $data['url'];?>"><?php if(!empty($data['typeid'])) { ?><?php if(Model_Menu_New::get_nav_title($data['typeid'],'shortname')=='一路小团') { ?>一路旅行<?php } else { ?><?php echo Model_Menu_New::get_nav_title($data['typeid'],'shortname');?><?php } ?>
<?php } else { ?><?php echo $data['title'];?><?php } ?>
</a></strong>
            ...
            <div class="manage-block">
                <div class="update-box">
                    ...
                    <div class="con-list" id="newversion_list">
                        <script type="text/javascript" src="http://www.stourweb.com/api/cms/version"></script>
                    </div>
                </div>
                <div class="market-box">
                    ...
                    <div class="con-list">
                        <ul id="yx_article_list">
                            <script type="text/javascript" src="http://www.stourweb.com/api/cms/article"></script>
                        </ul>
                    </div>
                </div>
            </div>
