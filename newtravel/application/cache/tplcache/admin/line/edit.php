...
<table class="content-tab" body_script=0TxsEC >
<tr>
            ...
            <div class="manage-nr">
                ...
                <div class="w-set-tit bom-arrow">
                    <span class="on" id="column_basic" onclick="Product.switchTab(this,'basic')"><s></s>基础信息</span>
                        <?php $n=1; if(is_array($columns)) { foreach($columns as $col) { ?>
                          <span id="column_<?php echo $col['columnname'];?>" onclick="Product.switchTab(this,'<?php echo $col['columnname'];?>',switchBack)"><s></s><?php echo $col['chinesename'];?></span>
                        <?php $n++;}unset($n); } ?>
...
>主站</option>
                                        <?php $n=1; if(is_array($weblist)) { foreach($weblist as $web) { ?><?php var_dump($web['webid'],$info['webid']);?>
                                           <option <?php if($web['webid']==$info['webid']) { ?>selected="selected"<?php } ?>
 value="<?php echo $web['webid'];?>"><?php echo $web['webname'];?></option>
                                        <?php $n++;}unset($n); } ?>
                                    </select>
                            </dd>
                        </dl>
                ...
                <div id="content_jieshao" class="product-add-div content-hide">
                    <div class="ap-div-top">
                        <dl>
                            ...
                            <dd>
                                <div class="temp-chg">
                                    <a <?php if($info['isstyle']==2 OR empty($info['isstyle'])) { ?>class="on"<?php } ?>
 href="javascript:void(0)" onclick="togStyle(this,2)">标准版</a>
                                    <a <?php if($info['isstyle']==1) { ?>class="on"<?php } ?>
 href="javascript:void(0)" onclick="togStyle(this,1)">简洁版</a>
                        ...
                        <dl>
                            ...
                            <dd>
                            <div class="on-off">
                              <input type="radio" id="" class="fl mt-8" onclick="togDiner(1)" name="showrepast" value="1" <?php if($info['showrepast']==1 OR !isset($info['showrepast'])) { ?>checked="checked"<?php } ?>
>
                              <label class="fl mr-20 ml-5">显示</label>
                              <input type="radio" id="" class="fl mt-8" onclick="togDiner(0)" <?php if($info['showrepast']==0 AND isset($info['showrepast'])) { ?>checked="checked"<?php } ?>
 name="showrepast" value="0">
                    ...
                    <div id="content_linedoc" class="product-add-div content-hide">
                        <div  class="up-pic">
                            ...
                            <ol id="linedoc-content">
                                ...
                                <li><span class="name"><?php echo $info['linedoc']['name'][$k];?></span><input type="hidden" name="linedoc[name][]" value="<?php echo $info['linedoc']['name'][$k];?>"><input type="hidden" class="path" name="linedoc[path][]" value="<?php echo $v;?>"><span class="del">删除</span></li>
                                <?php $n++;}unset($n); } ?>
                            </ol>
                        </div>
                    </div>
...
<!--右侧内容区-->
<script>
 var is_spot_open=<?php if(St_Functions::is_system_app_install(5)) { ?>1<?php } else { ?>0<?php } ?>
;
