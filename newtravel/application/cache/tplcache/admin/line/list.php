...
<head>
<meta charset="utf-8">
<title>线路列表-思途CMS<?php echo $coreVersion;?></title>
...
if(window.display_mode!=2)
 ...
 var id=record.get('id');
     ...
     return "<a href='javascript:;' class='row-mod-btn' title='修改套餐'  onclick=\"modify_suit('"+id+"')\"></a>&nbsp;&nbsp;<a href='javascript:void(0);' title='删除' class='row-del-btn' onclick=\"delSuit('"+id+"')\"></a>";
                                      ...
                                      {
                                          return '<a href="javascript:;" class="row-add-suit-btn" onclick="ST.Util.addTab(\'添加套餐\',\'line/admin/line/addsuit/<?php if(isset($_GET['menuid'])) { ?>menuid/<?php echo $_GET['menuid'];?>/<?php } ?>
