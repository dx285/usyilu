...
<body>
<table class="content-tab" margin_bottom=GxLpkt >
    <tr>
              ...
              <div class="add-class">
                  ...
                  <dl>
                      ...
                      <dd style="height: 200px;line-height: 20px">
                          <?php Common::getEditor('content',$info['description'],$sysconfig['cfg_admin_htmleditor_width'],120,'Line');?>
                      </dd>
                  </dl>
              </div>
              <div class="add-class">
                  ...
                  <dl>
                      ...
                      <dd>
                              <div class="on-off">
                                  <input type="radio" name="paytype" value="1" <?php if($info['paytype']=='1' OR empty($info['paytype'])) { ?>checked="checked"<?php } ?>
 />全款支付 &nbsp;
                              ...
                              <div class="price_sub">
                                  <div>
                                      <table class="price_tb">
                                          ...
                                          <tr>
                                              <td class="tit">价格描述：</td><td><input type="text" class="set-text-xh text_700 mt-2" style="width: 300px" value="<?php echo $info['lastoffer']['description'];?>" name="description"></td>
                                          </tr>
                                          <tr>
                                              <td class="tit">单房差：</td><td><input type="text" class="set-text-xh text_700 mt-2" style="width: 100px" value="<?php echo $info['lastoffer']['roombalance'];?>" name="roombalance"></td>
                                          </tr>
                                          <tr>
                                              <td class="tit">库存：</td><td><input type="text" class="set-text-xh text_100 mt-2" name="number" maxlength="4" value="<?php echo $info['lastoffer']['number'];?>"> <span style="color:gray;padding-left:10px">-1表示不限</span></td>
                                          </tr>
                                      </table>
                                  </div>
