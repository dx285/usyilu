    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="w-set-tit bom-arrow">
                <?php echo  Stourweb_View::template('admin/line/attrid/kind_top');  ?>
    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'line/admin/attrid/list/action/read/typeid/<?php echo $typeid;?>',  //读取数据的URL
                    update:  SITEURL+'line/admin/attrid/list/action/save/typeid/<?php echo $typeid;?>',
                    destroy:  SITEURL+'line/admin/attrid/list/action/delete/typeid/<?php echo $typeid;?>'
                },
                reader: 'json'
            },
            autoLoad: true,
        ...
        window.attr_treepanel = Ext.create('Ext.tree.Panel', {
            ...
            viewConfig: {
                ...
                listeners: {
                    ...
                    drop: function (node, data, overModel, dropPosition, eOpts) {
                        ...
                        Ext.Ajax.request({
                            url: SITEURL+'line/admin/attrid/list/action/drag/typeid/<?php echo $typeid;?>',
                            params: params,
                            method: 'POST',
            ...
            columns: [
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">属性</span>',
                    dataIndex: 'attrname',
                    id: 'attr_name',
                    sortable:false,
                    locked: false,
                ...
                {
                    text: '<span class="grid_column_text">所属站点</span>',
                    dataIndex: 'webid',
                    //  tdCls:'attr-al-mid',
                    width: '9%',
                    draggable: false,
                ...
                {
                    text: '<span class="grid_column_text">系统属性</span>',
                    dataIndex: 'issystem',
                    //  tdCls:'attr-al-mid',
                    width: '9%',
                    draggable: false,
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'line/admin/attrid/list/action/addsub/typeid/<?php echo $typeid;?>',
        params: {pid: pid},
        success: function (response) {
...
function updateField(ele,id,field,value,type,callback)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"line/admin/attrid/list/action/update/typeid/<?php echo $typeid;?>",
        method  :  "POST",
        datatype  :  "JSON",
...
function attrSet(id,typeid)
{
    ...
    var boxurl = SITEURL+'line/admin/attrid/config/id/'+id+'/typeid/'+typeid;
