                        ...
                        <dl class="list_dl">
                         ...
                         <dl class="list_dl">
                                 ...
                                 <dl class="list_dl certify hide optial">
                                     ...
                                     <dd><img src="{$qua['zz_litpic']}" width="215" height="136">&nbsp;&nbsp;<a href="{$qua['zz_litpic']}" target="_blank">查看</a></dd>
                                 </dl>
                                 ...
                                 <dl class="list_dl">
                                     ...
                                     <dd class="verify">
                                         <input type="radio" name="vstatus" id="c1" {if $info['verifystatus']==1}checked{/if} value="1"><label for="c1">待审核</label>
                                         <input type="radio" name="vstatus" id="c3" {if $info['verifystatus']==3}checked{/if} value="3"><label for="c3">通过</label>
                                         <input type="radio" name="vstatus" id="c2" {if $info['verifystatus']==2}checked{/if} value="2"><label for="c2">不通过</label>

                                     </dd>
                                 </dl>
                                 <dl class="list_dl {if $info['verifystatus']!=3}hide{/if}" id="product_right" >
                                     <dt class="wid_90">供应商权限：</dt>
                                     <dd>
                                         {loop $product_list $p}
										    {php}$r_kind = explode(',',$info['kindid']){/php}
                                            <label><input type="checkbox" class="right" name="kindid" value="{$p['id']}" {if in_array($p['id'],$r_kind)}checked="checked"{/if}>{$p['modulename']}</label>
                                         {/loop}
                                     </dd>
                                 </dl>
                                 <dl class="list_dl reason {if $info['verifystatus']!=2}hide{/if}">
