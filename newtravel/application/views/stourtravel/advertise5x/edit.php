...
<head>
    ...
    <style>
        .product-add-div .up-list-div ul {padding: 10px;border: 1px solid #dcdcdc;  }
        .product-add-div .up-list-div ul li {width: auto;border: none;  }
        .product-add-div .up-list-div ul li span {display: block;width: 600px;padding-left: 30px;height: 25px;margin: 5px 0;  }
        .red{ color: #f00;}
        ...
        .w-set-tit .refresh-btn{ margin-top: 5px;}
        .help_icon{ float: right; margin: 8px 10px 0 0;}
    </style>
</head>
                    ...
                    <div class="product-add-div">
                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                <dt>广告尺寸：</dt>
                                <dd>
                                    <input name="size" {if $info['is_system']=='1'}disabled="true"{/if} class="set-text-xh img_text" type="text" value="{$info['size']}">
                                </dd>
                            </dl>
                            <dl>
                                <dt>广告备注：</dt>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#webid').change(function(){
            if($('#adposition').val().length>1){
                select_change();
            }
        });
        function select_change(){
            var data={
                'prefix':$('#adposition').val(),
                'is_system':'0',
                'is_pc':$('#ispc').val(),
                'webid':$('#webid').val()
            }
        ...
        $("#btn_save").click(function () {
            if($('#adposition').val()==0 || $('#custom_label_err').html().length>0){
                return false;
            }
            $.ajaxform({
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201610.1202&DomainName=&ServerIP=unknown&SerialNumber=10563293" ></script>
