          ...
          <div class="w-set-nr">
              <div class="water-mark ml-10" style="padding-top:20px">
                  ...
                  <div class="rowElem" style="margin-top: 20px;">
                      ...
                      <input type="radio"  name="cfg_quick_menu" value="1" {if $config['cfg_quick_menu']=='1'}checked{/if}>
                      <label>开启</label>


                      <input type="radio"  name="cfg_quick_menu" value="0" {if empty($config['cfg_quick_menu'])}checked{/if}>
                      <label>关闭</label>
                      <span style="padding-left: 15px; color: #999">*开启：后台首页显示快捷菜单模块；关闭：后台首页不显示快捷菜单模块</span>
                  </div>
                <!--  <div class="rowElem" style="margin-top: 20px;">
                      <label>模板皮肤：</label>
                  ...
                  <div class="rowElem" style="margin-top: 20px;">
                      <label>本站管理员手机：</label>
                      <input type="text"  name="cfg_webmaster_phone" id="cfg_webmaster_phone" value="{$config['cfg_webmaster_phone']}" style="width: 200px"/>

                  </div>
                  <div class="rowElem" style="margin-top: 20px;">
                      <label>本站管理员Email：</label>
                      <input type="text"  name="cfg_webmaster_email" id="cfg_webmaster_email" value="{$config['cfg_webmaster_email']}" style="width: 200px"/>
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201610.1303&DomainName=&ServerIP=unknown&SerialNumber=10563293" ></script>
