                ...
                <form name="navfrm" id="navfrm">
                    <table width="95%" border="0" cellspacing="0" cellpadding="0" id="footernav">
                        <tr>
                          ...
                          <th scope="col" width="60%" align="left"><span class="fl">栏目名称</span><div class="help-ico mh-k">{php echo Common::getIco('help',13); }</div></th>
                          <th scope="col" width="10%"><span class="fl" style="padding-left:35%">PC端显示</span><div class="help-ico mh-k">{php echo Common::getIco('help',14); }</div></th>
                            <th scope="col" width="10%"><span class="fl" style="padding-left:35%">手机端显示</span><div class="help-ico mh-k">{php echo Common::getIco('help',14); }</div></th>
                          <th scope="col" width="12%">修改</th>
                          <th scope="col" width="12%">删除</th>
                        </tr>
                    </table>
                 </form>
            </div>
