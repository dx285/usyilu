            ...
            columns: [
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var   html = "<a href='javascript:void(0);' title='编辑'  class='row-mod-btn' onclick=\"goModify("+id+")\"></a>&nbsp;&nbsp;<a href='javascript:void(0);' title='删除' class='row-del-btn' onclick=\"del(" + id + ")\"></a>";
                        return html;
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201609.2201&DomainName=&ServerIP=unknown&SerialNumber=10563293" ></script>
