...
Ext.onReady(
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                type: 'ajax',
                extraParams: {folder: '{$folder}',issline:issline,ismobile:ismobile,version:version},
                api: {
...
function uploadFile(obj,path) {
        ...
        $.upload({
            ...
            fileName: 'filedata',
            // 其他表单数据
            params: {path: path,ismobile:ismobile,version:version},
            // 上传完成后, 返回json, text
            dataType: 'json',
...
function pageedit(id,ext)
{
    ...
    var boxurl = SITEURL+'filemanager/pageedit/parentkey/templet/itemid/1?file='+file+'&ext='+ext+'&issline='+issline+'&ismobile='+ismobile+'&version='+version;
