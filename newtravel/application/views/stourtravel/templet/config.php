      ...
      <div id="templet_list">
          ...
          {loop $templet_list $v}
            <div class="onedata" id="tpl_{$v['id']}">
              ...
              <div class="v2">
                  <a href="javascript:;" class="row-mod-btn" data-path="{$v['path']}" data-version="{$v['version']}" ></a>
...
<script language="JavaScript">
    ...
    function addEvent()
    {
        ...
        $(".v2").find('.row-mod-btn').unbind('click').click(function(){
            ...
            var url = SITEURL+'filemanager/index/parentkey/templet/itemid/1/folder/'+folder+'/ismobile/'+ismobile+'/version/'+version;
         ...
         $(".v2").find('.row-del-btn').unbind('click').click(function(){
            ...
            ST.Util.confirmBox("提示","确定删除？",function() {
                $.ajax({
                    ...
                    data: {path:path,ismobile:ismobile},
                    dataType: 'json',
        ...
        $(".v3").find('input').unbind('click').click(function(){
            ...
            $.ajax({
                ...
                data:{id:id,pageid:pageid,ismobile:ismobile},
                dataType:'json',
                success:function(data){
                  if(data.status){
    ...
    function uploadTemplet()
    {
            ...
            $.upload({
                ...
                fileType: 'zip',
                // 其他表单数据
                params: {pageid: pageid,ismobile:ismobile},
                    ...
                    if(data.status&&$("#tpl_"+data.id).length<=0){
                        var html='<div class="onedata" id="tpl_'+data.id+'">'
                            ...
                            html+='<div class="v2">  <a href="javascript:;" class="row-mod-btn" data-path="'+data.path+'" ></a>'+
                                   '&nbsp;&nbsp;&nbsp; <a href="javascript:;" data-version="'+data.version+'"  data-path="'+data.path+'" class="row-del-btn"></a></div>';
