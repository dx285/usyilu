...
<body style="overflow:hidden" top_border=jmToSj >
    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'templet/index/action/read/ismobile/{$ismobile}',  //读取数据的URL
                    update:  SITEURL+'templet/index/action/save/ismobile/{$ismobile}',
                    destroy:  SITEURL+'templet/index/action/delete/ismobile/{$ismobile}'
                },
                reader: 'json'
            },
            autoLoad: true,
...
function config(id)
{
    ...
    var boxurl = SITEURL+'templet/config/pageid/'+id+'/ismobile/'+ismobile;
