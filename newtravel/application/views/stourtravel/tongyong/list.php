	   ...
	   columns:[
           ...
           },
           {
               ...
               renderer : function(value, metadata,record) {
                   ...
                   return '<a href="javascript:;" class="row-add-suit-btn" onclick="ST.Util.addTab(\'添加套餐\',\'tongyong/suit/menuid/{$_GET['menuid']}/parentkey/product/typeid/{$typeid}/itemid/{$typeid}/action/add/productid/'+id+'\')">添加套餐</a>';
               },
               listeners:{
                   afterrender:function(obj,eopts)
                   {
