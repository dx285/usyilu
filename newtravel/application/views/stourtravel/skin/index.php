...
<head>
<meta charset="utf-8">
<title clear_background=jmoMll >皮肤设置</title>
          ...
          <div class="w-set-nr">
              <div class="water-mark ml-10">
                  ...
                  <div class="rowElem" style="margin-top: 20px;">
                      <label>皮肤方案：</label>
                      {loop $skinlist $skin}
                      <div style="display: inline-block;margin-left: 12px;" class="skinitem" data-skinid="{$skin['id']}">
                      ...
                      <label for="skin_id_{$skin['id']}">{$skin['title']}<div style="display:inline-block;width:31px;height: 16px;margin-left:3px; vertical-align:middle;margin-bottom:2px;background-color: {$skin['main_color']}"></div></label>
                      </div>
