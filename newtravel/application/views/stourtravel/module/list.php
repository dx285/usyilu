   ...
   <tr>
    ...
    <td valign="top" class="content-rt-td" style="overflow:hidden">
        ...
        <div class="search-bar filter" id="search_bar">
            ...
            <div class="change-btn-list mt-4 ml-10">
                <span class="change-btn-xz btnbox" id="version" data-url="box/index/type/moduleversion" data-result="result_version">版本切换&nbsp;&gt;&nbsp;<span id="result_version">全部</span></span>
...
<script>
	   ...
	   columns:[
           {
			   ...
			   },
               {
                   ...
                   menuDisabled:true,
                   renderer:function(value,metadata,record){
                       var version = record.get('version')+".X";
                       return "<a href='javascript:;' class='line-title'>"+version+"</a>";
                   }
  ...
  function del(id,issystem)
  {
    ...
    function addModule()
    {
        ...
        ST.Util.showBox('添加模块',boxurl,700,650,function(){ window.product_store.load(); });
    }
   //修改
   function modify(id)
   {
       var boxurl = SITEURL+'module/edit/id/'+id;
       ST.Util.showBox('模块修改',boxurl,700,650,function(){ window.product_store.load(); });
   }
