...
class Controller_Index extends Stourweb_Controller
{
    ...
    public function action_index3()
    {
        ...
        $this->assign('starttime', $starttime);
        $this->assign('endtime', $endtime);
        $this->display('stourtravel/index_5');
    }
    private function _delete_menu_cache(){
    ...
    {
        $article = Common::objectToArray(json_decode(Common::http('http://www.stourweb.com/api/cms/article')));
