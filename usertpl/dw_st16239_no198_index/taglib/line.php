...
class Taglib_Line
{
    private static $basefiled = 'a.id,a.webid,a.aid,a.title,a.storeprice,a.litpic,a.startcity,a.kindlist,a.attrid,a.bookcount,a.storeprice,a.sellpoint,a.iconlist,a.satisfyscore,a.linebefore,a.islinebefore';
