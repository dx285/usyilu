...
FENXIAO;
            ...
            if($fx && Model_Fenxiao::is_installed()){
                ...
                $fxurl='http://'.$refer['host'].$refer['path'].'?fxcode='.$fx['fxcode'];
                $fxurl=urlencode($fxurl);

                $member['fx_member']=1;
                $member['fx_btn']=<<<FXBTN
<a style="width:30%;background:#FFCCCC;color:#fff" href="http://{$GLOBALS['main_host']}/plugins/fx_phone/index/share?url={$fxurl}&[fx_url]">我要分销</a>
FXBTN;
            }
