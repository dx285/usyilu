...
<table width="100%" border="0" style="border-collapse: collapse;">
  ...
  <tr align="center" >
    <td colspan="3" class="top_title" style="height:40px;">' . $year . '年' . $month . '月</td>
  ...
  <tr>
  	<td colspan="5">
		<table width="100%" border="0" >
			<tr align="center">
				<td style="height:30px;font-size:12px">一</td>
				<td style="height:30px;font-size:12px">二</td>
				<td style="height:30px;font-size:12px">三</td>
				<td style="height:30px;font-size:12px">四</td>
				<td style="height:30px;font-size:12px">五</td>
				<td style="font-size:12px">六</td>
				<td style="font-size:12px">天</td>
			</tr>
';
        ...
        while ($day <= $lastday)
        {
            ...
            //判断儿童,老人是否有报价,如果成人价为空,则取儿童,老人报价.
            $dayPrice = empty($dayPrice) ? $day_child_price : $dayPrice;
            $dayPrice = empty($dayPrice) ? $day_old_price : $dayPrice;
            ...
            $tdStyle = "height='44'";
            //判断当前的日期是否小于今天
            $tdcontent = '<span class="num">' . $uday . '</span>';
            if ($defaultmktime >= $currentmktime)
            {


                if ($dayPrice && ($priceArr[$cdayme]['number'] == -1 || $priceArr[$cdayme]['number'] > 0))
                {
