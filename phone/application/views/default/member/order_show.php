    ...
    <div class="mid_content">
        <div class="confirm_order_msg">
            ...
            <ul>
                ...
                <li><span>订单状态：</span><em class="no">{$info['statusname']}</em></li>
            </ul>
            ...
            <ul>
                ...
                <div class="consume-box">
                    ...
                    <div class="consume-pic"><img src="http://{Common::get_main_prefix()}{Common::get_domain()}/res/vendor/qrcode/make.php?param={$info['eticketno']}&size=7"></div>
                </div>
            </ul>
            {/if}
            <div class="total">总额：<span><i class="currency_sy">{Currency_Tool::symbol()}</i>{$info['payprice']}</span></div>
