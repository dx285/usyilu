...
{request "pub/header/typeid/$typeid/isshowpage/1"}
  ...
  <section>
      ...
      <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{}' >
        <ul class="am-slides">
            {loop $info['piclist'] $pic}
             <li><img src="{Common::img($pic[0],640,435)}"></li>
            {/loop}
        </ul>
      </div><!--轮播图-->
      ...
      <div class="line_show_top">
        ...
        <p class="jf">积分抵现:{$minsuit['jifentprice']}&nbsp;&nbsp;评论送积分:{$minsuit['jifencomment']}&nbsp;&nbsp;预订送积分:{$minsuit['jifenbook']}</p>
          ...
          <p class="num">
        	...
        	<span class="pl"><b>{$info['commentnum']}</b>人点评<i>&gt;</i></span>
        </p>
      </div><!--顶部介绍-->
      ...
      <div class="line_tablist_box">
        ...
        {loop $tongyong $row}
      <div class="line_tablist_box">
      	<div class="bt_tit"><span>{$row['chinesename']}</span>
        </div>
        <div class="cont_nr">
            {$row['content']}
        </div>
