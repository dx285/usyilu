...
<section>
    ...
    <div class="mid_content">
        <div class="am-slider am-slider-default"  id="home-column">
            <ul class="am-slides">
        ...
        <div class="st_sale_box">
            ...
            <div class="st_sale_con">
                <div class="st_advpic_l">
                    ...
                    {if !empty($data)}
                    <a href="{$data['adlink']}"><img src="{$defaultimg}" st-src="{Common::img($data['adsrc'],340,340)}" title="{$data['adname']}"></a>
                    {/if}
                    {/st}
                </div>
                <div class="st_advpic_r">
                    ...
                    {if !empty($data)}
                    <a href="{$data['adlink']}"><img src="{$defaultimg}" st-src="{Common::img($data['adsrc'],340,170)}" title="{$data['adname']}"></a>
                    {/if}
                    {/st}
                ...
                <ul class="st_list_ul">
                    ...
                    <li>
                        <a href="{$row['url']}">
                            ...
                            <p class="tit">{$row['title']}<span class="sell-point">{$row['sellpoint']}</span></p>
        ...
        <div class="tuan_home_con st_hot_list">
            ...
            <ul class="tuan_hm_list">
                ...
                <li>
                    <a href="{$v['url']}">
                        <div class="pic"><img src="{$defaultimg}" st-src="{Common::img($v['litpic'],640,435)}"/></div>
        ...
        <div class="jb_list_home">
            ...
            <ul>
                ...
                <li>
                    <a class="pic" href="{$row['url']}"><img src="{$defaultimg}" st-src="{Common::img($row['litpic'],640,429)}"/><span class="day_date"><strong><b>{$row['day']}</b>日游</strong><em>{$row['startdate']}出发</em></span></a>
        ...
        <div class="gl_hot_list">
            ...
            <ul>
                ...
                <li>
                    <a href="{$row['url']}">
                        <div class="pic"><img src="{$defaultimg}" st-src="{Common::img($row['litpic'],100,68)}" alt="{$row['title']}"/></div>
                        <div class="con">
