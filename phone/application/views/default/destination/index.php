...
<body>
    ...
    <section>
        ...
        <div class="mid_content">
            ...
            <div class="am-slider am-slider-default" id="dests-column" >
                <ul class="am-slides">
                    {st:ad action="getad" name="s_dest_index_1"}
                    {loop $data['aditems'] $v}
                    <li><a href="{$v['adlink']}"><img src="{$defaultimg}" original-src="{Common::img($v['adsrc'],640,300)}" title="{$v['adname']}"></a></li>
                    {/loop}
                    {/st}
                </ul>
            </div><!--轮播图-->
                ...
                <ul class="hot_dest_list">
                    ...
                    <li>
                        <a href="{$cmsurl}{$row['pinyin']}">
                            <img src="{Common::img($row['litpic'],197,90)}" alt="{$row['kindname']}" />
