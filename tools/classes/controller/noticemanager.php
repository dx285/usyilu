...
class Controller_NoticeManager extends Stourweb_Controller
{
    ...
    protected function get_order_msgtypelist($model_info)
    {
        $result = NoticeCommon::create_product_order_msgtype(NoticeCommon::PRODUCT_ORDER_UNPROCESSING_MSGTAG, $model_info['pinyin']);
        $result = array_merge($result, NoticeCommon::create_product_order_msgtype(NoticeCommon::PRODUCT_ORDER_PROCESSING_MSGTAG, $model_info['pinyin']));
        $result = array_merge($result, NoticeCommon::create_product_order_msgtype(NoticeCommon::PRODUCT_ORDER_PAYSUCCESS_MSGTAG, $model_info['pinyin']));
        $result = array_merge($result, NoticeCommon::create_product_order_msgtype(NoticeCommon::PRODUCT_ORDER_CANCEL_MSGTAG, $model_info['pinyin']));
    ...
    public function action_order_sms()
    {
        ...
        $msg_config_data = $this->get_order_msgtypelist($model_info);
        $msgtypelist = array();
    ...
    {
        $msg_config_data = NoticeCommon::create_member_msgtype();
        $msgtypelist = array();
