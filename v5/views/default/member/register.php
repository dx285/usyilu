    ...
    <div class="st-login-wp">
    	<div class="st-reg-box">
      	<div class="reg-tabnav">
        	<span class="on" data-type="phone">手机注册</span>
            <i></i>
            <span data-type="email">邮箱注册</span>
        </div>
            <script>
                $(function(){
      	...
      	<div class="reg-cont-box">
           ...
           {/if}
              ...
              <input type="password" name="password2" id="password2" class="reg-text w230" placeholder="请输入登录密码" />
                <span class="msg_contain"></span>
            ...
            <li>
                ...
                <div class="agree-term">
                    <span class="fl">
                    <input type="checkbox" name="agreement" id="agreement" checked />同意<a href="javascript:;" class="show_agreement" target="_blank">《{$GLOBALS['cfg_member_agreement_title']}》</a></span> <span class="msg_contain"></span>   </div>
           ...
           <form id="emailfrm" method="post" action="{$cmsurl}member/register/doreg">
        	<ul id="email_reg" style="display: none">
          	<li>
            	<span class="bt-sp">登录帐号</span>
              <input type="text" class="reg-text w230" id="email" name="email" placeholder="请输入邮箱帐号" />
                <span class="msg_contain"></span>
            </li>
                ...
                <li>
                   <span class="bt-sp">密码</span>
                  <input type="password" class="reg-text w230" name="e_password1" id="e_password1" placeholder="请输入登录密码" />
                    <span class="msg_contain"></span>
                    <span class="complex_contain"></span>
                ...
                <li>
                    ...
                    <div class="agree-term">
                    <span class="fl">
                    <input type="checkbox" name="e_agreement" id="e_agreement" checked />同意<a href="javascript:;" class="show_agreement" target="_blank">《{$GLOBALS['cfg_member_agreement_title']}》</a></span> <span class="msg_contain"></span>   </div>
                    {/if}
                </li>
                <input type="hidden" name="frmcode" value="{$frmcode}"/>
...
{request "pub/footer"}
 ...
 {if !empty($GLOBALS['cfg_member_agreement_open'])}
 <div class="layer-wrap-content hide">
