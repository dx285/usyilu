    ...
    <div class="login-small-box">
        <form id="loginfrm" method="post">
            <div class="login-small-con">
                ...
                <div class="user-num">
                    <input type="text" name="logincode" id="frmcode" class="user-zh" placeholder="请输入验证码">
                    <span class="yzm"><img id="login_order_yzm" src="{$cmsurl}captcha"></span>
                    <span class="change-next" id="chang_yzm">换一张</span>
                </div>
                <div id="login_order_error"></div>
                <div class="login-btn"><a class="login" id="login_order" href="javascript:">登 录</a></div>
                <div class="reg-find-acc">没有账号，<a href="{$cmsurl}member/register">免费注册</a><a class="fr" href="{$cmsurl}member/findpwd">找回密码</a></div>
            </div>
