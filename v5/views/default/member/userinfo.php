        ...
        <div class="user-cont-box">
            ...
            <dl>
              ...
              <dd>
                  ...
                  {else}
                   <span class="phone-num">未绑定</span> <a class="revise" href="{$cmsurl}member/index/modify_phone?change=1">绑定手机&gt;</a>
                  {/if}
              </dd>
            </dl>
            <dl>
              ...
              <dd>
                ...
                {else}
                     <span class="mail">未绑定</span> <a class="revise" href="{$cmsurl}member/index/modify_email?change=1">绑定邮箱&gt;</a>
                {/if}
