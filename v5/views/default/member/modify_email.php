        ...
        {include "member/left_menu"}
          <div class="user-cont-box">
              <div class="verify-number">
                  <h3 class="yz-tit">{if $change==1}修改邮箱{else}绑定邮箱{/if}</h3>
                      ...
                      <div class="verify-con">
                          ...
                          <dl>
                              ...
                              <dd>
                                  ...
                                  <input type="button" class="get-number sendemail" value="获取邮箱验证码">
                          ...
                          <div class="pc-txt">
                              <p>没有收到邮件？</p>
                              <p>1. 请查看邮件是否发送至邮箱中的垃圾邮箱中。</p>
                              <p>2. 由于系统或者网络原因存在延迟，请耐心等待。</p>
                          </div>
                      </div>
        ...
        $('.sendemail').click(function(){
            ...
            $.post(url,{email:email,token:token},function(data) {
                if(data.status)
                {
                    ...
                    $(".tsmsg").html('邮箱验证码已发送到你的新邮箱,请登陆邮箱查看验证!');
                    $(".tsmsg").show();
                    code_timeout(60);
                    return false;
                }
