                    ...
                    <div class="user-address">
                        <div class="user-address-wrap">
                            ...
                            {if count($address_list)<20}
                                <div class="user-address-tit">新增收货地址</div>
                                <div class="user-address-block">
                                <form id="addfrm" method="post">
                                    <ul class="address-item">
                                    <li>
                                        <strong class="item-bt">所在地区<i>*</i></strong>
                                    ...
                                    <li>
                                        <strong class="item-bt">详细地址<i>*</i></strong>
                                        <div class="item-nr">
                                            <textarea name="address" id="address" class="ads-textarea fl" placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码，楼层和房间号等信息"></textarea>
                                        </div>
                                    </li>
                                    <li>
                                        <strong class="item-bt">邮政编码<i>*</i></strong>
                                        <div class="item-nr">
                                            <input type="text" name="postcode" id="postcode" class="default-text fl" />
                                        </div>
                                    </li>
                                    <li>
                                        <strong class="item-bt">收件人<i>*</i></strong>
                                        <div class="item-nr">
                                            <input type="text" name="receiver" id="receiver" class="default-text  fl" />
                                        </div>
                                    </li>
                                    <li>
                                        <strong class="item-bt">联系电话<i>*</i></strong>
                                        <div class="item-nr">
                                    ...
                                    <li>
                                        ...
                                        <div class="item-nr">
                                            <label class="radio-label"><input type="checkbox" name="is_default" class="check-btn" value="1" />设置默认收货地址</label>
                                        </div>
                                    </li>
                                    <li>
                                        <strong class="item-bt">&nbsp;</strong>
                                        <div class="item-nr">
                                            <a class="save-btn add-save" href="javascript:;">保存</a>
                                        </div>
                                    </li>
                                </ul>
                                </form>
                            ...
                            <div class="user-address-block mt50">
                                <div class="address-save-txt">已保存了{count($address_list)}条地址，还能保存{php echo 20-count($address_list);}条地址</div>
                                <table class="address-table-list" div_head=BVxsEC >
                                    <tr class="tr-hd">
                                        <th width="10%">收货人</th>
                                        <th width="35%">收货地址</th>
                                        <th width="10%">邮政编码</th>
                                    ...
                                    <tr class="tr-bd">
                                        ...
                                        <td>
                                            <div class="cz">
                                                <a class="revise modify" href="javascript:;" data-info='{json_encode($address)}'>修改</a>|<a class="delete delete-btn" href="javascript:;" data-id="{$address['id']}">删除</a>
                                            </div>
                                        </td>
                                        <td>
                                            {if $address['is_default']}
                                                <a class="default-btn"  href="javascript:;">默认地址</a>
                                            {else}
                                                <a class="default-set set_default" data-id="{$address['id']}" href="javascript:;">设为默认</a>
                                            {/if}
                                        </td>
                                    </tr>
                                    {/loop}
...
<div class="layer-wrap-content modify-box hide">
    <div class="address-larey-block">
        <div class="user-address-tit">修改收货地址<i class="close-ico"></i></div>
        <div class="user-address-block">
            ...
            <ul class="address-item">
                ...
                <li>
                    <strong class="item-bt">详细地址<i>*</i></strong>
                    <div class="item-nr">
                        <textarea name="m_address" id="m_address" class="ads-textarea fl" placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码，楼层和房间号等信息"></textarea>
                    </div>
                </li>
                <li>
                    <strong class="item-bt">邮政编码<i>*</i></strong>
                ...
                <li>
                    <strong class="item-bt">&nbsp;</strong>
                    <div class="item-nr">
                        <label class="radio-label"><input type="checkbox" name="m_is_default" id="m_is_default" class="check-btn" value="1">设置默认收货地址</label>
                    </div>
                </li>
                <li>
                    <strong class="item-bt">&nbsp;</strong>
                    <div class="item-nr">
                        ...
                        <a class="save-btn m-save" href="javascript:;">保存</a>
                    </div>
                </li>
            </ul>
            </form>
