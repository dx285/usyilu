    ...
    <div class="user-home-box">
        ...
        <div class="user-home-msg">
            <div class="user-msg-con">
                ...
                <div class="user-txt">
                    <p class="name">{$info['nickname']}<span class="level">{Common::member_rank($info['mid'],array('return'=>'current'))}</span></p>
                    <p class="phone-num">会员等级：{Common::member_rank($info['mid'],array('return'=>'rankname'))}</p>
                ...
                <table width="100%" border="0">
                    ...
                    <tr>
                        <td height="114">
                            <div class="con">
                                <dl>
                                    <dt><a href="{$order['producturl']}" target="_blank"><img src="{Common::img($order['litpic'],110,80)}" alt="{$order['title']}" /></a></dt>
                                    <dd>
                        ...
                        <td align="center">
                            ...
                            {elseif $order['status']=='5' && $order['ispinlun']!=1}
