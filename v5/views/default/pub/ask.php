    ...
    <div class="st-consult">
        ...
        <div class="st-tj-question">
            ...
            <div class="msg">
                ...
                <span><em>验证码：</em><input type="text" id="checkcode" style="padding-left: 5px" /><img src="{$cmsurl}captcha"  onClick="this.src=this.src+'?math='+ Math.random()" width="80" height="30" /></span>
                <span><em>昵称：</em>
    ...
    $.ajax({
        ...
        success:function(data){
            if(data.status){
                ...
                $txt = '<input type="text" name="nickname" id="nickname" /><a href="{$cmsurl}member/login/">登录</a>';
