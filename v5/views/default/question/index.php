      ...
      <div class="st-main-page">
        ...
        <div class="st-wenda-box">
        	...
        	<div class="online-wenda">
          	<div class="online-tit"><h3>{$channelname}</h3><a href="#ask">我要提问</a></div>
            <div class="online-conlist">
                ...
                {loop $list $row}
					...
					<span class="date"><span class="name">{$row['nickname']}</span>发表：{Common::mydate('Y-m-d',$row['addtime'])}</span>
                  </div>
                	<div class="nr">
                  ...
                  <div class="hf">
                  	<span class="con">{strip_tags($row['replycontent'])}{if strlen($row['replycontent'])>40}<a class="more" href="javascript:;">【详情】</a>{/if}</span>
                    <span class="date">回复：{Common::mydate('Y-m-d',$row['replytime'])}</span>
                  </div>
                </li>
                {/loop}
              </ul>
          ...
          <div class="online-quiz">
             ...
             <form id="askfrm" method="post" action="{$cmsurl}question/add">
                ...
                <div class="box">
                	...
                	<label class="nm"><input type="checkbox" name="anonymous" value="1" id="CheckboxGroup1_0">匿名</label>
                    {/if}
                </div>
              </div>
                ...
                <div class="box">
                	<input type="text" class="ol-text w250" name="mobile" id="mobile" placeholder="电话" value="{$userinfo['mobile']}" />
                	<input type="text" class="ol-text w250 ml15" name="email" id="email" placeholder="邮箱" value="{$userinfo['email']}" />
                	<input type="text" class="ol-text w250 mt15" name="weixin" id="weixin" placeholder="微信" />
                	<input type="text" class="ol-text w250 mt15 ml15" name="qq" id="qq" placeholder="QQ" value="{$userinfo['qq']}" />
                </div>
              </div>
            
            	<div class="data-conlist">
              	<span class="tit">问题标题：</span>
                <div class="box">
              ...
              <div class="online-tjbtn"><a href="javascript:;" class="btn-submit">提 交</a></div>
