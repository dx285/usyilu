    ...
    <div class="product_box">
        <div class="sidle_hot">
            ...
            <ul>
                ...
                <li>
                    <s></s>
                    <div class="pic"><a href="{$s['url']}" target="_blank"><img class="lazyimg" src="{Product::get_lazy_img()}" st-src="{Common::img($s['litpic'],180,122)}" alt="{$s['title']}"></a></div>
                    <p class="tit"><a href="{$s['url']}" target="_blank">{$s['title']}</a></p>
                    <p class="jg">{if $s['price']>0}<i class="currency_sy">{Currency_Tool::symbol()}</i>{$s['price']}{else}电询{/if}</p>
                </li>
                {/loop}
                {/st}
            </ul>
            ...
            <div class="st-tabcon" style="display: block;">
                <ul>
                    ...
                    <li {if $s%4==0}class="mr_0"{/if}>
                        <a class="pic" href="{$h['url']}" target="_blank"><img class="lazyimg" alt="{$h['title']}" src="{Product::get_lazy_img()}" st-src="{Common::img($h['litpic'],180,122)}"></a>
