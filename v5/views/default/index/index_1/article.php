...
<div class="st-slideTab">
    ...
    <div class="st-tabcon">
        <ul class="st-gl-list">
            ...
            {if $n==1}
            <li class="first">
                <div class="pic"><a href="{$a['url']}"><i class="hot">hot</i><img src="{Product::get_lazy_img()}" st-src="{Common::img($a['litpic'],386,263)}" alt="{$a['title']}"/></a></div>
            ...
            {elseif $n<4}
            <li>
                <div class="pic"><a href="{$a['url']}"><i class="hot">hot</i><img src="{Product::get_lazy_img()}" st-src="{Common::img($a['litpic'],180,122)}" alt="{$a['title']}"/></a></div>
                <div class="con">
