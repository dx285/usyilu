<!doctype html>
<html>
<head script_table=IVxsEC >
<meta charset="utf-8">
    <title>{if !empty($searchtitle)}{$searchtitle}{else}{$seoinfo['seotitle']}{/if}-{$webname}</title>
    {if $seoinfo['keyword']}
...
{request "pub/header"}
  ...
  <div class="big">
    ...
    <div class="st-guide">
        {st:position action="nav" typeid="$typeid" searchtitle="$_GET['keyword']"}
    </div><!--面包屑-->
