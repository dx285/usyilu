...
<div class="layer-wrap-content modify-box hide">
    <div class="address-larey-block">
        <div class="user-address-tit">收货地址<i class="close-ico"></i></div>
                    ...
                    success:function(data){
                        if(data.status){
                            ...
                            if(address_id>0){
                                ...
                                if(is_default){
                                    li+= '<span class="attr">默认地址</span>';
                                }else{
                                    li+= '<a class="set set-default" data-id="'+data.insert_id+'" href="javascript:;">设为默认</a>';
                                }
                                li+= '</span>';
                                li+= '<a class="xg xg-btn" data-info='+data.json+' href="javascript:;">修改本地址</a>';
                                li+='</label>';
                                li+='</li>';
