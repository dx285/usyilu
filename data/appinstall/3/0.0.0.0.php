...
$sqls = array(
    //model
    'sline_model' => 'where id=4 and pinyin="article"',
    //page
    'sline_page' => 'where pagename in ("article_index","article_list","article_show") or (pid=0 and kindname="攻略模块")',
    //site_page
    'sline_site_page' => 'where pagename in ("article_index","article_list","article_show") or (pid=0 and kindname="攻略模块")',
    //advertise_5x
    'sline_advertise_5x' => 'where is_system="1" and prefix="article_index"',
    //sline_menu_new
    'sline_menu_new' => 'where typeid=4',
    //sline_nav
    'sline_nav' => 'where typeid=4',
    'sline_m_nav' => 'where m_typeid=4'
);
