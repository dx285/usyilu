...
CREATE TABLE `sline_member_order` (
  ...
  `distributor` varchar(255) DEFAULT NULL COMMENT '分销商编号',
  ...
  `distributorprice` float DEFAULT NULL COMMENT '分销商结算价',
  ...
  `dingjin` float(10,2) DEFAULT '0.00' COMMENT '是否支持定金',
  ...
  `distributororderexdata` longtext COMMENT '分销商户订单扩展数据',
  `supplierorderexdata` longtext COMMENT '供应商户订单扩展数据',
  `paytime` int(10) DEFAULT NULL COMMENT '支付时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员订单表.';-- <xjx> --
