...
CREATE TABLE `sline_m_nav` (
  ...
  `m_typeid` int(11) DEFAULT NULL COMMENT 'model编号',
  ...
  `m_issystem` tinyint(1) NOT NULL DEFAULT '0' COMMENT '系统导航',
  `m_isopen` int(1) DEFAULT '1' COMMENT '是否开启',
  PRIMARY KEY (`id`),
  KEY `navid` (`navid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='手机导航扩展表';-- <xjx> --
